	...
	return (
		<div>
			{inputs.map((_, index) => (
				<div
					key={index}
					className="flex flex-row items-center mb-4 max-w-[350px] gap-4"
				>
					<InputEdit
			...
			<button
				...
				className="mt-4 p-2 bg-white text-color-active max-w-[120px] w-full border-[1px] border-[#E4E4E4] rounded-3xl text-xs"
			>
				Добавить
			</button>
		</div>
