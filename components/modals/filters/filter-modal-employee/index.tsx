...
const FilterModal: FC<IFilterModal> = () => {
	...
	const { items: divisions, isLoading: isLoadingDivisions } =
		useGetDictionariesDivisions(searchDivision);
	...
	const { items: roles, isLoading: isLoadingRoles } =
		useGetDictionariesRoles(searchRoles);
