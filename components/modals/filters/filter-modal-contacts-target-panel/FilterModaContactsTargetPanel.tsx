...
const FilterModaContactsTargetPanel: FC<IFilterModal> = () => {
	const { modals, toggleModal } = useModalStore();
	const isOpen = modals["filter-contacts-target-panel"]?.isOpen;
	...
	const toggleSidebar = (): void => {
		toggleModal("filter-contacts-target-panel");
	};
...
export default FilterModaContactsTargetPanel;
