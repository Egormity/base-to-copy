...
const FilterModalLibraryQuiz: FC<IFilterModal> = () => {
	const { modals, toggleModal } = useModalStore();
	const isOpen = modals["filter-library-quiz"]?.isOpen;
	...
	const toggleSidebar = (): void => {
		toggleModal("filter-library-quiz");
	};
...
export default FilterModalLibraryQuiz;
