...
const FilterModalLibraryMedia: FC<IFilterModal> = () => {
	const { modals, toggleModal } = useModalStore();
	const isOpen = modals["filter-library-media"]?.isOpen;
	...
	const toggleSidebar = (): void => {
		toggleModal("filter-library-media");
	};
...
export default FilterModalLibraryMedia;
