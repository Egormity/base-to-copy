...
import {
	...
	MATERIALS_TOP_LEVEL_FOLDER_ID,
	POLLS_FOLDER_TYPE_ID,
	POLLS_TOP_LEVEL_FOLDER_ID,
...
const FilterModalLibrarySearchItemTree: FC<IItemFilterModal> = ({
	...
	if (from === "materials") topLevelFolderId = MATERIALS_TOP_LEVEL_FOLDER_ID;
	if (from === "polls") topLevelFolderId = POLLS_TOP_LEVEL_FOLDER_ID;
